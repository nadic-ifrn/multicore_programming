//gcc -g -Wall -fopenmp -o bin/histogram-2.0 histogram-2.0.c
//./bin/histogram-2.0 30 0.0 10 100000000
...
//   srandom(0);
   ...
   //  data[i] = (min_meas + (max_meas - min_meas)*random()/((double) RAND_MAX)) * (min_meas + (max_meas - min_meas)*random()/((double) RAND_MAX))/5.0;
