...
//clang++ -fopenmp -I/usr/local/include/opencv4 -L/usr/local/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_videoio -lopencv_imgcodecs warp.c -o warp_image
...
int main(int argc, char** argv) {
    ...
    imwrite("warped_image.png", outputImage);
