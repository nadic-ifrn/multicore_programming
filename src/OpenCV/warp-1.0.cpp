...
//clang++ -fopenmp -I/usr/local/include/opencv4 -L/usr/local/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_videoio -lopencv_imgcodecs warp-1.0.cpp -o bin/warp_image-1.0
//./bin/warp_image-1.0 input/dogy_caty.png 0.01
