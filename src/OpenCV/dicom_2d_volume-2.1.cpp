//clang++ -fopenmp -I/usr/local/include/opencv4 -L/usr/local/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_videoio -lopencv_imgcodecs -I/usr/local/include -I/usr/local/include/nifti  -ldcmimgle -ldcmdata -loflog -lofstd -lopencv_viz -lniftiio dicom_2d_volume-2.1.cpp -o bin/dicom_2d_volume-2.1
//./bin/dicom_2d_volume-2.1 input/dicom_slices_pat01 201 output/dicom_pat01.png 8
