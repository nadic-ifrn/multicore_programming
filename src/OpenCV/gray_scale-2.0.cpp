//clang++ -fopenmp -I/usr/local/include/opencv4 -L/usr/local/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_videoio -lopencv_imgcodecs gray_scale-2.0.cpp -o bin/gray_scale-2.0
#include <stdio.h>
